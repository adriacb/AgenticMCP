...
from .base import APIConfig, BaseConfigModel
...
class FastAPIConfigModel(BaseConfigModel):
    ...
    api_title: str = Field(default="MCP Agent API", alias="FASTAPI_API_TITLE")
    api_description: str = Field(default="API for MCP Agent", alias="FASTAPI_API_DESCRIPTION")
    api_version: str = Field(default="0.1.0", alias="FASTAPI_API_VERSION")

class FastAPIConfig(APIConfig):
